...
VALUES		('BUILDING_TCM_CONCERT_HALL', 	'YIELD_SCIENCE',					5),
			('BUILDING_TCM_CONCERT_HALL', 	'YIELD_CULTURE',					2),
			('BUILDING_TCM_CONCERT_HALL', 	'YIELD_GREAT_GENERAL_POINTS',		0),
			('BUILDING_TCM_CONCERT_HALL', 	'YIELD_GREAT_ADMIRAL_POINTS',		0);
--==========================================================================================================================	
-- Building_GoldenAgeYieldMod
--==========================================================================================================================
INSERT INTO Building_GoldenAgeYieldMod 
			(BuildingType, 					YieldType,				Yield)
VALUES		('BUILDING_TCM_CONCERT_HALL', 	'YIELD_SCIENCE',		20);
--==========================================================================================================================	
-- Building_Flavors
--==========================================================================================================================					
...
SELECT		Class,		('UNIT_TCM_GRENZER'),   ('TECH_RIFLING'),		39, 	 250,  ObsoleteTech, 500, 		RequiresFaithPurchaseEnabled, Moves, CombatClass, Domain, DefaultUnitAI, 'Kaiserjaeger',		'Created to defend the Habsburg’s southern gains from the Ottomans, the Grenz Infantry were an elite Croatian division of the Austro-Hungarian army tasked with manning the border with the Caliphate. Always cautious of another attack from them, it was vital that the border was secured at all times, even keeping a division there when there was no threat from the Ottomans. While at war, Austria-Hungary would use these border guards to fight in other theaters, making them among the most legendary units of the Austro-Hungarians.', 'Replaces the Fusilier. May pick recon promotions and get promotions faster.', 'A stronger version of the fusilier. May pick promotions from the recon tree and get promotion faster.',	MilitarySupport, MilitaryProduction, IgnoreBuildingDefense, AdvancedStartCost, Mechanized, CombatLimit, MinAreaSize, Pillage, XPValueDefense, Conscription, ('ART_DEF_UNIT_GRENZER'),	0,					('UNITS_JFD_JAEGER_FLAG_ATLAS'), 0, 			 ('JFD_JAEGER_ATLAS'), MoveRate
...
--==========================================================================================================================
-- UnitPromotions jaeger
--==========================================================================================================================	
INSERT OR REPLACE INTO UnitPromotions 
			(Type, 					Description, 					Help, 						Sound, 				ExperiencePercent, 	CannotBeChosen, PortraitIndex, MovesChange, 	IconAtlas, 			PediaType, 			PediaEntry)
VALUES		('PROMOTION_JAEGER',	'Feldjaeger',	'Earns 15% more experience from combat',	'AS2D_IF_LEVELUP', 	15,					1, 				59, 			1,				'ABILITY_ATLAS', 	'PEDIA_ATTRIBUTES', 'Feldjaeger');
--==========================================================================================================================
...
VALUES		('PROMOTION_SURVIVALISM_2',				'UNITCOMBAT_GUN'),
			...
			('PROMOTION_WOODLAND_TRAILBLAZER_II',	'UNITCOMBAT_GUN'),
			('PROMOTION_SCOUTING_1',				'UNITCOMBAT_GUN'),
